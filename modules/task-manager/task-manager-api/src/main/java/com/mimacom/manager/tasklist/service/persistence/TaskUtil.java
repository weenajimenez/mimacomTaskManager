...
/**
 * The persistence utility for the task service. This utility wraps <code>com.mimacom.manager.tasklist.service.persistence.impl.TaskPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class TaskUtil {
	 ...
	 */
	public static Task fetchByTaskId(long taskId) {
		return getPersistence().fetchByTaskId(taskId);
	}
	 ...
	 * @return the matching task, or <code>null</code> if a matching task could not be found
	 */
	public static Task fetchByTaskId(long taskId, boolean useFinderCache) {
		return getPersistence().fetchByTaskId(taskId, useFinderCache);
	}
	 ...
	 */
	public static Task removeByTaskId(long taskId)
		throws com.mimacom.manager.tasklist.exception.NoSuchTaskException {

		return getPersistence().removeByTaskId(taskId);
	}
