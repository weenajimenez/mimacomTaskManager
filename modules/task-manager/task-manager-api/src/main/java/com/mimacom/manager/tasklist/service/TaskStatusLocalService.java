...
public interface TaskStatusLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mimacom.manager.tasklist.service.impl.TaskStatusLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the task status local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link TaskStatusLocalServiceUtil} if injection and service tracking are not available.
	 */
